# 1 "src/pic18f4520/interrupt/interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/pic18f4520/interrupt/interrupt.c" 2
...
# 5 "src/pic18f4520/interrupt/interrupt.h" 2
...
# 2 "src/pic18f4520/interrupt/interrupt.c" 2
...
void Interrupt_GlobalEnable( void )
{
    ...
    RCONbits.IPEN = 0x01;
# 22 "src/pic18f4520/interrupt/interrupt.c"
    INTCONbits.GIE_GIEH = 0x01;
# 33 "src/pic18f4520/interrupt/interrupt.c"
