# 1 "src/board/display_7_seg/display_7_seg_map.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/board/display_7_seg/display_7_seg_map.c" 2

# 1 "src/board/display_7_seg/display_7_seg_map.h" 1
...
# 5 "src/board/display_7_seg/display_7_seg_map.h" 2

# 1 "src/board/display_7_seg/../../pic18f4520/gpio/gpio.h" 1
...
# 5 "src/board/display_7_seg/../../pic18f4520/gpio/gpio.h" 2
# 6 "src/board/display_7_seg/display_7_seg_map.h" 2
# 46 "src/board/display_7_seg/display_7_seg_map.h"
typedef struct {
    uint8_t characters_vector [0x0A];
...
# 2 "src/board/display_7_seg/display_7_seg_map.c" 2
...
uint8_t display_show(display_7_seg_t *displayShow)
{
    ...
    if(displayShow->characters_vector_pos < 0x0A - 1){

        PORTB = displayShow->characters_vector[displayShow->characters_vector_pos];
        displayShow->characters_vector_pos++;

      }else {

        PORTB = displayShow->characters_vector[0x0A - 1];
